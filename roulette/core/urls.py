...
urlpatterns = [
    ...
    path('languages/delete/<int:pk>/', LanguageDeleteView.as_view(template_name='core/form.html'), name='language-delete'),
    ...
    path('ideas/update/<int:pk>/', LanguageUpdateView.as_view(template_name='core/form.html'), name='idea-update'),
    path('ideas/delete/<int:pk>/', LanguageDeleteView.as_view(template_name='core/form.html'), name='idea-delete'),
    ...
    path('projects/update/<int:pk>/', LanguageUpdateView.as_view(template_name='core/form.html'), name='project-update'),
    path('projects/delete/<int:pk>/', LanguageDeleteView.as_view(template_name='core/form.html'), name='project-delete'),
]
