...
urlpatterns = [
    ...
    path('ideas/delete/<int:pk>/', LanguageDeleteView.as_view(template_name='core/delete.html'), name='idea-delete'),
    ...
    path('projects/delete/<int:pk>/', LanguageDeleteView.as_view(template_name='core/delete.html'), name='project-delete'),
]
